...
def send_budget_email_customer(budget_id):
	...
	email_text = email_text + '<strong>Imagem escolhida:</strong> #'+ budget.image.code + ' <a href="http://186.226.56.5/~sdmarketing/idea10-site/'+ budget.image.path +'">Clique aqui para visualizar a imagem</a><br>'
